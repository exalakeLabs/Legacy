 ...
 * Author      : Wilf Coles
 * 
 * Role        : main routine for pseudo name server capsule
 * 
...
pnamemain_clean_up(CORBA_Environment *ev, 
                   DAIS_TermType type);
...
main(int argc, char **argv)
{
  ...
  DAIS_capsule_set_terminator(pnamemain_clean_up);
