...
#define defaultRGBBkGnd RGB(255,255,255)
...
#define defaultListCtrlStyle LVS_NOSORTHEADER | LVS_REPORT | LVS_SINGLESEL | LVS_SHOWSELALWAYS | LVS_NOCOLUMNHEADER
#define defaultSizeDY 17
