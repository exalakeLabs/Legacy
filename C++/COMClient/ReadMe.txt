========================================================================
       MICROSOFT FOUNDATION CLASS LIBRARY : COMClient
========================================================================


AppWizard has created this COMClient application for you.  This application
not only demonstrates the basics of using the Microsoft Foundation classes
but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your COMClient application.
...
COMClient.h
    ...
    CCOMClientApp application class.
...
res\COMClient.ico
    ...
    icon is included by the main resource file COMClient.rc.
...
COMClientDlg.h, COMClientDlg.cpp - the dialog
    These files contain your CCOMClientDlg class.  This class defines
    the behavior of your application's main dialog.  The dialog's
    template is in COMClient.rc, which can be edited in Microsoft
	Visual C++.

DlgProxy.h, DlgProxy.cpp - the automation object
    These files contain your CCOMClientDlgAutoProxy class.  This class
...
StdAfx.h, StdAfx.cpp
    ...
    named COMClient.pch and a precompiled types file named StdAfx.obj.
