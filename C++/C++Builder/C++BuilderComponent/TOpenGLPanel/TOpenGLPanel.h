//---------------------------------------------------------------------------
#ifndef TOpenGLPanelH
#define TOpenGLPanelH
//---------------------------------------------------------------------------
...
protected:
        // Variables
        TNotifyEvent FOnPaint,FOnResize,FOnInit;
...
__published:
        ...
        BEGIN_MESSAGE_MAP
              ...
              MESSAGE_HANDLER(WM_PALETTECHANGED,TWMPaletteChanged,
                                                             WMPaletteChanged)
              MESSAGE_HANDLER(WM_QUERYNEWPALETTE,TWMQueryNewPalette,
                                                             WMQueryNewPalette)
